...
export const ARTICLES: ArticleMeta[] = [
  {
    catalogOrder: 1,
    slug: "pisa-2025-chile-comprension-democracia",
    title: "PISA 2025: cuando comprender se vuelve una urgencia democrática",
    category: "Informes",
    pubDate: "2026-09-08",
    excerpt:
    ...
    seoDescription:
      "Chile sigue lejos del promedio OCDE en PISA 2025. El desafío no es sólo acceder a información, sino comprenderla, contrastarla y usarla con criterio en tiempos de IA.",
    ogTitle: "PISA 2025: cuando comprender se vuelve una urgencia democrática",
    ogDescription:
      "El nuevo informe PISA deja una advertencia para Chile: la comprensión lectora, la IA y la autonomía informativa ya son parte central de la vida democrática.",
    twitterTitle: "PISA 2025 en Chile: comprender se vuelve una urgencia democrática",
    twitterDescription:
      "Acceder a información ya no basta. PISA 2025 muestra por qué Chile necesita más comprensión, criterio y autonomía informativa.",
  },
  ...
  {
    catalogOrder: 3,
    slug: "informarse-en-chile-hoy-menos-ruido-mas-criterio",
