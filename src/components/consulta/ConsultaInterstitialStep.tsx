  ...
  return (
    <div>
      <div className={st.stepHead}>
        <p className={st.eyebrow}>Si quieres, un poco más</p>
        <h3 id="consulta-interstitial-title" className={st.prompt} tabIndex={-1}>
        ...
        <p className={st.capHint}>Si sigues, son 6 preguntas más.</p>
      </div>
