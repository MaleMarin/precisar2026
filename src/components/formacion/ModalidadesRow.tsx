    ...
    <section className="mx-auto w-full max-w-5xl px-4 sm:px-6 py-16 sm:py-20">
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
        <article
          ...
          style={{ border: "0.5px solid rgba(255, 75, 11, 0.35)", backgroundColor: "rgba(2, 54, 97, 0.2)" }}
        >
          <p style={{ color: "var(--brand-flame-text)", fontSize: 11, fontWeight: 600, letterSpacing: "0.14em" }}>ONLINE</p>
        ...
        <article
          ...
          style={{ border: "0.5px solid rgba(255, 75, 11, 0.35)", backgroundColor: "rgba(2, 54, 97, 0.2)" }}
        >
          <p style={{ color: "var(--brand-flame-text)", fontSize: 11, fontWeight: 600, letterSpacing: "0.14em" }}>PRESENCIAL</p>
          <p className="mt-3 text-sm leading-relaxed" style={{ color: "#A0A0A0" }}>
