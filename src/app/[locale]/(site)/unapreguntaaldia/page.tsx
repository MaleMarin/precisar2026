...
export const metadata = {
  ...
  description:
    "Treinta días, treinta preguntas sobre cómo vivís en línea. Tarjetas con frente y reverso; descarga el PDF para compartir en clase, trabajo o familia.",
};
      ...
      <div className="prose-precisar max-w-none space-y-6">
        <div className="space-y-3">
          <p className="text-xl font-semibold leading-snug tracking-tight text-[var(--fg)] sm:text-2xl">
            Treinta días. Treinta preguntas sobre cómo vivís en línea.
          </p>
        ...
        <div className="space-y-4">
          ...
          <p>
            ...
            desafío, otra manera de mirar lo que hacés todos los días con una pantalla.
          </p>
        ...
        <div className="space-y-4">
          ...
          <p>
            Pasá el mouse o tocá la tarjeta para ver el reverso. Deslizá hasta el final para descargar el
            recurso completo en PDF — para compartirlo en tu clase, tu trabajo, tu familia o con quien
            quieras empezar una conversación.
          </p>
        </div>
      </div>
