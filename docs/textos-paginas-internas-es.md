## Textos compartidos (navegación, inicio, pie)
...
Abrir el chat Bot ONDA (beta) en una pestaña nueva
...
Propuesta política de alfabetización
...
Precisar en X (se abre en una pestaña nueva)

Precisar en Instagram (se abre en una pestaña nueva)

Precisar en Facebook (se abre en una pestaña nueva)

Precisar en YouTube (se abre en una pestaña nueva)

© {year} Precisar. Salvo que se indique lo contrario, los contenidos de Precisar se distribuyen bajo la licencia
...
Potencia el uso de la tecnología.
...
Precisar · Potencia el uso de la tecnología
...
Cada día se produce y circula más información de la que podemos procesar.

463

Se crean 463 exabytes de datos por día.

26M

Nos demoraríamos 26 millones de años para leerlos todos.

Un ejemplo en América Latina

96,5%

de los hogares tiene acceso a internet

53%

de la ciudadanía no entiende lo que lee

5M

de personas necesitan fortalecer habilidades digitales

En Chile, el acceso ya no es la única brecha. El desafío actual es fortalecer las capacidades de las personas para comprender, analizar y usar de manera útil la información que atraviesa su vida cotidiana y cívica, no solo en el ámbito noticioso ni únicamente en entornos digitales, sino también en servicios, instituciones, plataformas y otros espacios donde las personas necesitan orientarse y actuar.

La información llega en fragmentos. La IA responde antes de que termines la pregunta. Los medios cambian más rápido de lo que los entendemos. Y aún así, cada persona ya atraviesa todo eso, a su manera, desde donde está.

En Precisar fortalecemos las capacidades de discernir: para que las personas puedan evaluar la información que reciben y construir su propio criterio.

Programas

Conectados hay millones. Con criterio, todavía faltan muchos.

Diseñamos herramientas, contenidos y experiencias formativas, presenciales y digitales, que fortalecen el pensamiento crítico, la seguridad digital y el compromiso ciudadano.

Conoce nuestros programas:

Conoce la propuesta

Ciudades Conectadas con Sentido — Talleres y acompañamiento a municipios para fortalecer habilidades digitales en comunidad.

Hub Digital Consciente — Experiencias inmersivas de cultura digital para todas las edades, adaptables a cualquier espacio.

Aprender Digital: Nunca es Tarde — Un programa para personas mayores que quieren conectarse con más seguridad y autonomía.

Educación mediática para docentes — Herramientas y recursos para que los docentes lleven el pensamiento crítico al aula.

Curso para Servidores Públicos — Formación práctica en habilidades digitales para quienes trabajan en el Estado.

Bot Onda:

Onda en Mano

Para mensajes, cadenas, links dudosos y audios. Te ayuda a mirar señales, entender qué es confiable y usar IA con criterio.

Onda Civita

Para entender el mundo público: Estado, leyes, economía, medio ambiente e historia reciente. Lenguaje claro, contexto y datos.

Onda Profes

Para docentes y equipos educativos: actividades, buenas prácticas, rúbricas y uso transparente de IA en el aula.

Nueva función: escucha comunitaria

Onda no solo responde. También puede recoger dudas, experiencias y señales reales de quienes usan el chat, para que el equipo las revise y entienda mejor qué está faltando explicar.

Ciudades Conectadas con Sentido

Realizamos talleres y acompañamos a instituciones y municipios en el diseño e implementación de estrategias de educación mediática y digital: mediante diagnósticos participativos, talleres comunitarios, sus vecinos ganan habilidades para acceder a información fiable, desarrollar pensamiento crítico y participar con confianza en el entorno digital.

Hub Digital Consciente

Experiencias inmersivas de cultura digital para todas las edades, adaptables a eventos, municipios y entornos educativos. Mediante carteles, videos y aplicaciones interactivas centradas en el usuario, abordamos temas como IA, desinformación y privacidad, transformándolos en vivencias participativas que fomentan la reflexión sobre el impacto de la tecnología en la sociedad.

Aprender Digital: Nunca es Tarde

Un programa especialmente creado para personas mayores, con talleres presenciales y en línea que combinan uso práctico de dispositivos, seguridad digital y dinámicas sociales, fortaleciendo su autonomía y conexión con familiares y comunidad.
...
Queremos entender cómo recibes la información hoy y cómo te gustaría recibirla: qué formatos te ayudan, qué tono te genera confianza, qué te falta para entender mejor, acceder con más facilidad y compartir con más criterio. Tus respuestas llegan directamente a medios, instituciones y tomadores de decisiones para que mejoren la manera en que informan.

Responder ahora →

06 · EDUCACIÓN MEDIÁTICA

Comprender la información también es una habilidad que se aprende.

Cuatro dimensiones para leer el mundo digital
con más criterio, más conciencia y más autonomía.
...
Sitio nuevo · 05 · Precisando

Cómo circula la información y qué efectos produce.

Precisando es la editorial de Precisar: un espacio de artículos y debates para leer el entorno digital con más contexto, criterio y profundidad. Explora publicaciones recientes y sus categorías.

En construcción. Pronto publicaremos las notas aquí.

03 · Saberes

Saber no es acumular datos. Es saber qué hacer con ellos.

Conocimiento abierto sobre cultura digital.

04 · Bot Onda

Onda no solo responde. También escucha.

Onda en Mano, Onda Civita y Onda Profes: tres conversaciones en el chat para orientarte sin sustituir tu juicio.
Servicio en beta.
...
./precisar-home/PrecisarHomeClient

next-intl/server

summary_large_image

## Agenda de Educación Mediática
...
Objetivos de la Propuesta de Política
...
En producción esta URL responve con experiencia propia (posible contenido
        dinámico o incrustado). Portar el recurso completo desde Wix sin pérdida de
        interacción.

## Curso Desinformación · Aquí No Pasa

¡Comienza ahora y no dejes que te la hagan!

/aqui-no-pasa/modulos/[n]
...
Atelier · Experiencia digital

Laboratorio editorial: tipografía serif, WebGL escultórico, scroll coreografiado.

## Consulta Observatorio

(Sin texto extraído en este archivo.)

## Contacto

Escribe en el formulario Contáctanos del pie de página.

Escribe en el formulario Contáctanos del pie de página.

## Cultura Digital · Tiras
...
¿Cómo lo hago? ¿qué botón? ¿qué ajuste de seguridad?

¿En qué se diferencian

¿Por qué importa distinguirlas?

¿Quién lo dice? ¿con qué evidencia? ¿qué intención tiene?
...
Analizar, evaluar, verificar, argumentar, derechos informacionales.

Arrastra cada ejemplo

Autonomía técnica y seguridad operativa.

Capacidades críticas sobre medios, mensajes y fuentes.

Citar correctamente y respetar licencias de autor

Compartir un documento en la nube con permisos correctos
...
Contrastar una noticia con tres fuentes independientes

Crear una videollamada con agenda y enlace

Crear una videollamada; cifrar un disco; gestionar contraseñas.

Derechos: acceso, autoría, privacidad, libertad de expresión, uso justo.

Detectar deepfakes en campaña

Detectar sesgos; verificar una imagen; reconocer desinformación.
...
Eliminar malware y actualizar el antivirus

Equilibra pensamiento crítico (AMI) con habilidades técnicas (Digital).

Evaluar la credibilidad de una fuente y detectar publicidad nativa.

Explicar cómo un algoritmo sesga tu feed

Habilidades técnicas y operativas con dispositivos y apps.

Hacer una copia de seguridad automática

Identificar titulares clickbait

Instalar, configurar, operar, mantener, solucionar problemas.

La brecha no es solo de acceso/uso; también de criterio y verificación.

Limpiar malware del PC

Pensamiento crítico y ciudadanía informada.
...
Reconocer publicidad nativa en un portal

Reducir desinformación requiere AMI; reducir fraudes requiere Alfabetización Digital.

Resolver problemas básicos de software/hardware.

Resultado buscado

Sentido crítico sobre mensajes, fuentes y contextos.
...
Todos los ejemplos han sido asignados ✓

Tres razones clave

Usar correo, videollamadas, hojas de cálculo, gestores de archivos.

Usar una herramienta de verificación de imágenes (OSINT)

Uso eficiente y seguro de tecnologías y servicios.
...
puede conectar o dividir, visibilizar o excluir.
...
## Agenda AMI-Chile · Propuesta política de alfabetización
...
1 · Marco institucional chileno

2 · Formación inicial en Chile

2 · Integración curricular —

3 · Formación continua en Chile

3 · Implementación territorial —

4 · Recursos pedagógicos chilenos

4 · Recursos y ecosistema —

5 · Monitoreo y evidencia —
...
agenda-ami-stats-heading

agendaAmi2030Col

agendaAmiPanel agendaAmiPanelAdult

agendaAmiPanel agendaAmiPanelMayores

agendaAmiPanel agendaAmiPanelNna

Alfabetización Digital

AMI · Alfabetización Mediática e Informacional

ami-fundamental-heading

ami-nudos-heading

ami-vs-digital-heading

Analizar cómo se construye una noticia y distinguir opinión de hecho.

Analizar, evaluar, verificar, argumentar, derechos informacionales.

Asesoría técnica para implementación de políticas

Autonomía técnica y seguridad operativa.

Bienestar: 53% con soledad digital
...
Ciudades AMI en 16 comunas.

Compartir un Drive con permisos

Competencias AMI explícitas. AMI en formación inicial y
                continua.

Competencias críticas insuficientes

Comprensión crítica: 44%+ sin base

Comprobar autoría y fecha

Conductas: 23% admite insultar por mensajes

Conectividad 96,5% pero vacío legal en AMI.

Conectividad: 80% con plan de datos propio
...
Consolidar gobernanza.

Contacto con extraños: 40% contactado; 48% interactúa
...
Crear Mesa Intersectorial AMI.

Crear una videollamada; cifrar un disco; gestionar contraseñas.

Currículum chileno: AMI marginal y fragmentada.

Definir institucionalidad coordinadora.

Democracia fortalecida: ciudadanía que identifica manipulación y debate con evidencia.

Derecho a explicación algorítmica. Accesibilidad en servicios
                digitales.

Derechos: acceso, autoría, privacidad, libertad de expresión, uso justo.

Desinformación: 63% creyó noticias falsas

Detectar deepfakes en campaña

Detectar sesgos; verificar una imagen; reconocer desinformación.

Digitalización: 66% para no quedar aislados

Diseñar Política Nacional con participación ciudadana.

Doble brecha: Sin herramientas y sin criterio

Economía del conocimiento: trabajo colaborativo con IA y emprendimiento.

Efectos: Desinformación / exclusión
...
escenarios-2030-heading

Estado actual de la legislación chilena

Evaluar la credibilidad de una fuente y detectar publicidad nativa.

Evaluar y ajustar pilotos.

Exposición: 27% vio contenidos violentos

FASE 1 — INSTITUCIONALIZACIÓN

FASE 2 — PILOTAJE

FASE 3 — ESCALAMIENTO

Financiamiento 2025–2026 asegurado.
...
Fractura social: brechas digitales no resueltas.
...
Inclusión intergeneracional: mayores autónomos; jóvenes responsables.

Innovación social: comunidades que usan IA para salud, educación y medio ambiente.

Instalar, configurar, operar, mantener, solucionar problemas.

Institucionalidad AMI con mandato legal. Mesa Intersectorial.
...
Integrar AMI en SIMCE/ENDDEIE.

Kits por nivel + plataforma nacional. Corresponsabilidad
                privada.
...
La sociedad algorítmica chilena sin brújula crítica.

La sociedad chilena digitalmente empoderada.

Legislar para institucionalizar — AMI como derecho ciudadano con marco normativo específico.

ley-marco-heading

LGE e Internet como servicio público: foco en acceso, no en uso crítico.

Liderazgo regional: Chile como referente iberoamericano.

Limpiar malware del PC

Llamado a acción para tomadores de decisiones chilenos

llamado-accion-heading

Medios chilenos: sin enfoque de alfabetización de audiencias.

Motivación: 82% quiere aprender

Niños, Niñas y Adolescentes

Observatorio Nacional AMI.

Observatorio Nacional AMI. Indicadores en SIMCE y ENDDEIE.
...
Pérdida de soberanía informativa: dependencia de plataformas extranjeras sin transparencia.

Personas adultas

Personas mayores

Precariedad laboral: reemplazo sin reconversión.

Preguntas guía

Presentaciones especializadas con datos y propuestas concretas

Propuesta: Ley Marco de AMI para Chile

reco-estrategicas-heading

Recomendaciones estratégicas para Chile

Recursos pedagógicos.

Red comunal con facilitadores locales. Priorizar NNA,
...
Reuniones informativas con equipos técnicos

Riesgos: 29% reporta fraudes

Sentido crítico sobre mensajes, fuentes y contextos.

Sin estándares AMI ni indicadores de impacto.

Sin habilidades funcionales

Sin política nacional ni institucionalidad coordinadora.

Sin transparencia algorítmica y derecho a explicación.

Sobre Agenda AMI-Chile

sobre-agenda-heading

Tres nudos críticos a resolver en Chile sobre AMI

Usabilidad: Plataformas poco amigables
...
vacio-normativo-heading

Vacíos críticos identificados en Chile
...
← Volver a Educación mediática

Educación mediática · Política
...
prose-precisar prec-article-body max-w-none
...
prec-link-arrow mt-12 inline-flex items-center gap-2
...
Versión en sitio anterior

## Explora

/ /precisando/explora

## Política de Privacidad | Precisar

(por ejemplo, dirección IP, tipo de navegador o
...
(por ejemplo, nombre, apellido, correo y
...
Datos que nos envías voluntariamente

Datos técnicos de conexión

Newsletter u otros registros
...
solo si activas explícitamente un formulario que
...
## Política de Privacidad BOT ONDA | Precisar

1. Quién es el responsable

2. Qué datos recogemos y para qué

2.1 En la versión web (sitio web / precisar.net)

2.2 En la versión WhatsApp
...
Acceso a los datos que tengamos sobre ti.

al usar el chat (web o WhatsApp) aceptas esta
          política. Si eres menor de edad, se recomienda que un padre o tutor conozca el uso
          del servicio.

alojamiento del chat web.
...
Atender tus consultas, generar respuestas con
...
Contenido que tú envías:

cuando usas ONDA por WhatsApp, los mensajes
          pasan por la infraestructura de Meta según su Política de Privacidad de WhatsApp.

Datos técnicos:

dirección IP, tipo de navegador y dispositivo, y
...
el tratamiento es necesario para darte
          el chat y las respuestas.

Eliminación de datos cuando la ley lo permita.
...
Limitación u oposición a cierto tratamiento.

los identificadores y el contenido que envías por WhatsApp
        se tratan según esta política y las condiciones de Meta; no conservamos tu número
        para fines distintos al servicio.

los mensajes y respuestas se procesan para generar
...
mensajes de texto, enlaces, imágenes o
...
Política de Privacidad BOT ONDA

Política de Privacidad BOT ONDA | Precisar

Portabilidad de los datos, cuando sea aplicable.

Prestar el mismo servicio de chat ONDA por WhatsApp:
...
procesamiento de texto e imágenes y generación de
          respuestas (y, si se usa, de voz).

Proveedores necesarios para el servicio:
...
texto, audios, imágenes o enlaces que
          mandas al número de ONDA por WhatsApp.

Última actualización: 27 de febrero de 2026

Vercel (u otro proveedor de hosting):

## Política de Privacidad Consulta | Precisar

(si la organización ha designado un
...
11.2 Compatibilidad con normativa futura:
...
3.3 Datos sobre Hábitos y Preferencias de Información

3.4 Datos sobre Habilidades y Necesidades de Alfabetización Mediática

3.5 Opiniones y Percepciones
...
4.2 Investigación Académica y Social

4.3 Diseño de Prototipos y Soluciones

4.4 Incidencia en Políticas Públicas
...
5.1 Consentimiento Libre, Informado, Específico e Inequívoco

5.2 Interés Legítimo

6. ¿Con quién compartimos sus datos personales?

6.1 Equipo de Investigación

6.2 Aliados Estratégicos

6.3 Publicaciones y Divulgación

6.4 Requerimientos Legales

6.5 Proveedores de Servicios
...
Ana Magdalena Marín Ladrón de Guevara
...
Consulta: ¿Cómo te Informas Hoy? · DemocraTICa.
...
corregir datos inexactos. Asunto: &quot;Solicitud
          de Rectificación de Datos Personales&quot;.

Correo electrónico:

Cualquier disputa relacionada con esta Política
        será resuelta conforme a las leyes de la República de Chile y la competencia de los
        tribunales chilenos.

cuando carezca de fundamento legal,
...
De manera opcional, podremos solicitar datos como: correo electrónico; nombre completo.
...
El tratamiento de estos datos sensibles se
...
en cualquier momento. Asunto:
          &quot;Revocación de Consentimiento&quot;. El tratamiento futuro se detendrá; los
          datos ya tratados lícitamente no serán afectados.

En el marco de la Consulta, recolectaremos las siguientes categorías de datos personales:
...
Esta Política entra en vigencia a partir del 31 de
...
Futuras comunicaciones sobre los resultados del estudio
...
La Consulta se centra en preguntas sobre: cómo se informa; qué medios utiliza (televisión, radio, prensa escrita, redes sociales, plataformas digitales, etc.); con qué frecuencia se informa; qué formatos prefiere (texto, video, audio, infografías, etc.); cuáles son sus temas de interés (política, economía, tecnología, salud, etc.).
...
Los análisis se presentarán siempre en forma agregada,
...
oponerse a tratamientos específicos. Asunto:
...
Podremos compartir sus datos personales si así lo exige: una ley vigente; un decreto
        o resolución; una orden judicial.
...
Promover políticas públicas y prácticas que fortalezcan
        el ecosistema informativo chileno.

Protección especial:

Puede revocar este consentimiento en
...
Su participación en la consulta no está
...
Cultura es identidad, memoria y creación. La educación mediática permite habitar ese espacio con consciencia y voz propia.

Educación mediática ampliada

El diálogo genera sentido

En el entorno digital, la cultura se multiplica y cambia de forma rápidamente. Las
        narrativas juveniles, los contenidos virales, las expresiones de pueblos
        originarios, el activismo de mujeres, las estéticas digitales o los debates
        públicos en redes son tan parte del campo cultural como un libro, un festival o
        una obra de arte.
...
La cultura no es un adorno: es la forma en que convivimos, nos reconocemos y nos
        expresamos. Está en lo que consumimos, en cómo hablamos, en los memes que
        compartimos, en los relatos que heredamos y en los que decidimos transformar.

La cultura no es una sola, homogénea o estática. Es múltiple, cambiante y viva. La
        educación mediática invita a reconocer esa diversidad como un valor, no como un
        obstáculo.

La educación mediática entra aquí no para juzgar, sino para ampliar. Nos da
        herramientas para entender qué sentidos se reproducen, cuáles se invisibilizan y
        cómo podemos intervenir de manera creativa, respetuosa y transformadora.

Las claves para entender la cultura en la educación mediática

Lo digital también es cultura

Los medios representan (y omiten)

Un enfoque cultural de la educación mediática permite reconocer el derecho a
        comunicar desde la diversidad, fomentar el diálogo intergeneracional y promover una
        ciudadanía capaz de construir sus propias narrativas, más allá de los discursos
        hegemónicos.
...
Educación Mediática en Aula

El apoyo a docentes y educadores con herramientas contextualizadas.

El desarrollo de pensamiento crítico, lectura informacional y habilidades para
          convivir en entornos digitales.

Este eje impulsa:

Este eje pone el foco en la formación de competencias mediáticas desde la niñez
        hasta la adultez mayor. No se trata solo de enseñar a usar tecnologías, sino de
        formar una ciudadanía capaz de entender, analizar y participar en la construcción
        del mundo digital e informativo.

Este eje se busca transformar la relación entre ciudadanía y medios de comunicación
        desde la raíz: el pensamiento crítico, el aprendizaje permanente y la capacidad de
        actuar con conciencia en la esfera pública.

Evaluar Información

La educación mediática no es solo para estudiantes ni solo para expertos. Es un
        derecho de todas las personas, en cualquier etapa de su vida, y una condición para
        construir sociedades más democráticas, informadas y empáticas.
...
La integración de la educación mediática e informacional en los currículos
          escolares, como competencia transversal.

La producción creativa y reflexiva de contenidos como forma de aprender haciendo.

La promoción de espacios de formación para personas adultas y mayores,
          reconociendo sus saberes y necesidades específicas.

No se trata solo de tener opiniones, sino de saber por qué las tenemos. El
        pensamiento crítico es la capacidad de observar, interpretar y cuestionar el mundo
        que nos rodea, incluyendo los mensajes mediáticos que consumimos.

Pensamiento Crítico

Producción de Contenidos

Vida Digital y Convivencia
...
Algoritmo y Sesgo Informativo

Aquí, la Educación Mediática se vuelve una práctica de autonomía. Porque quien no
        entiende cómo opera la tecnología, queda expuesto a manipulaciones invisibles: la
        lógica de los algoritmos, la recolección de datos personales, la viralización del
        odio o la creación de burbujas de información.
...
Este eje aborda cómo la tecnología modela nuestra forma de informarnos,
        comunicarnos y participar en la vida digital. No se trata solo de usar
        dispositivos, sino de entender cómo influyen en lo que vemos, pensamos y decidimos.

Este eje no busca enseñar a usar la tecnología &quot;correctamente&quot;, sino a
        habitarla con conciencia, cuestionarla con pensamiento crítico y transformarla con
        ética. Significa formar ciudadanos capaces de proteger su privacidad, de identificar
        sesgos en los sistemas automatizados, de detectar contenidos generados por
        inteligencia artificial, y de exigir un entorno digital más justo y transparente.

Inteligencia Artificial y Cultura Digital

La alfabetización mediática en clave tecnológica no es solo aprender a usar
        herramientas, sino a comprender los sistemas que las gobiernan.

La tecnología no es neutra. Lo que vemos en redes sociales, buscadores o
        plataformas está mediado por algoritmos que priorizan ciertos contenidos y silencian
        otros. Comprender cómo funcionan estos sistemas es clave para desarrollar una mirada
        crítica sobre la información que consumimos.
...
Vivimos en una sociedad hiperconectada, donde los dispositivos, las plataformas
        digitales y los algoritmos no solo median la información que recibimos, sino
        también nuestras emociones, decisiones y formas de relacionarnos. En este escenario,
        el eje Tecnología nos invita a mirar más allá de la interfaz.
...
participa-contact-email

participa-contact-mensaje

participa-contact-nombre

política de privacidad

prec-input min-h-[8rem] resize-y

prec-kicker mb-2 block
...
Muchas gracias por escribirnos. Te respondemos a la brevedad.
...
Descarga asociada al artículo

Descargar archivo

Equipo Precisar

not-prose mx-auto w-full max-w-4xl
...
Aprender Digital: Nunca es Tarde · Precisar

Aprenderás a identificar y evitar fraudes en línea, proteger tus datos personales y gestionar tu privacidad en redes y aplicaciones, asegurando una experiencia digital tranquila y sin riesgos. Te daremos las herramientas para sentirte seguro en cada clic.
...
Clases presenciales y virtuales, con apoyo individualizado.

color-mix(in oklab, #0a0a0a 72%, transparent)

digital plena y segura

Educación Mediática Digital

Empoderamiento Cívico

Encuentra un equilibrio saludable entre el tiempo que pasas en línea y tus actividades presenciales, utilizando las herramientas digitales para enriquecer tu vida y fortalecer tus vínculos sociales, sin que sustituyan las interacciones cara a cara. Promovemos un uso consciente y beneficioso de la tecnología.

Enseñamos a identificar la desinformación, reconocer sesgos y desarrollar un pensamiento crítico para navegar el mundo digital de forma informada. Esto te permitirá discernir la veracidad de la información y protegerte de contenidos engañosos.

Facilita trámites y comunicaciones, brindando independencia digital.

Fortalece lazos sociales y digitales con familiares y amigos.

Guías impresas y videos paso a paso para repasar a tu ritmo.

http://www.w3.org/2000/svg

Impacto en la comunidad

Información y servicios locales al alcance de la mano.

Inteligencia Artificial

La Inteligencia Artificial (IA) es la capacidad de las máquinas para imitar y realizar tareas que requieren inteligencia humana. Exploraremos cómo la IA está transformando nuestra vida diaria y el futuro. Descubriremos sus aplicaciones prácticas y cómo interactuar con ella de forma consciente.

Línea de ayuda y encuentros mensuales de repaso para resolver dudas.
...
Participación activa en iniciativas vecinales y plataformas ciudadanas.

Participantes se apoyan mutuamente y co-crean materiales que enriquecen el taller.
...
Alfabetización en IA y algoritmos
...
Capacita a equipos municipales en la integración de Educación Mediática y Digital en políticas y servicios urbanos, generando espacios de rendición de cuentas y comunicación abierta.
...
Desarrolla en la ciudadanía aptitudes de pensamiento analítico para cuestionar mensajes, detectar discursos de odio y desinformación, y participar en procesos de decisión local con argumentos basados en fuentes fiables.

Desinformación

Desinformación: Hechos vs. sentimientos sobre la información

Desmitificando el futuro y sus implicaciones.

Desmitificando la IA: qué es, cómo funciona y sus impactos en las personas.

Este taller fomenta hábitos saludables en el uso de la tecnología, abordando el bienestar emocional, la gestión del tiempo en pantalla y la construcción de una relación equilibrada con los dispositivos.
...
Estrategias que multiplican el impacto con educadores, bibliotecarios, equipos municipales y organizaciones comunitarias.

Experiencias dinámicas para que cada participante comprenda, use y gestione los medios
            digitales con autonomía.

Facilita el despliegue de iniciativas en plazas, centros de salud, transporte y otros espacios urbanos, creando una red de información accesible para todos los habitantes.

Formación en Cultura Digital

Formación en Cultura Digital para la Ciudadanía. Programas modulares para municipios.

Fortalece la resiliencia comunitaria frente a fraudes y amenazas en línea mediante la enseñanza de buenas prácticas de protección de datos, privacidad y uso ético de la tecnología.

Gestión del tiempo de pantalla y adicción digital.

Gobernanza local transparente

Hábitos saludables en el uso de la tecnología.

Herramientas prácticas para reconocer y evitar fraudes digitales, proteger datos personales y actuar frente a situaciones de riesgo en línea.

Impacto del uso de tecnología en la salud mental.

Impacto Directo en la Ciudadanía

Incorpora hábitos saludables de uso tecnológico y fomenta espacios de aprendizaje permanente que reducen la brecha digital y mejoran la inclusión social.
...
Programas · Ciudades Conectadas

Programas modulares

Promueve la comprensión de cómo funcionan los sistemas automatizados y sus sesgos, capacitando a los ciudadanos para evaluar críticamente el contenido filtrado o generado por IA.

Protegiendo identidad y datos.
...
Taller práctico para desarrollar el criterio necesario para navegar en un ecosistema de información complejo, distinguir hechos de opiniones, y detectar noticias falsas y manipulación informativa.
...
## Educación Mediática Digital para Docentes

Recursos didácticos, guías de aula y talleres para que los docentes preparen a sus estudiantes para un presente digital consciente, seguro y participativo.

4 sesiones en vivo por Zoom con actividades 'manos a la obra' y trabajo autocontrolado en la plataforma digital del Programa EducaMedios, para avanzar al ritmo de cada docente.

Acceso a guías, plantillas, videos y ejemplos listos para usar y adaptar en sus clases.
...
Al incorporar buenas prácticas de protección de datos y control de privacidad, se reducen significativamente los riesgos de ciberacoso y usos indebidos de la tecnología, garantizando un entorno digital más seguro.

Algoritmos y Inteligencia Artificial
...
Ayuda a tus estudiantes a desarrollar habilidades para pensar críticamente, reconocer contenidos falsos y actuar con confianza y respeto en el mundo digital.

Beneficios para tu comunidad escolar

Brindar herramientas a los educadores para guiar a los estudiantes en la creación de contenidos digitales de forma ética y responsable, respetando derechos de autor y promoviendo mensajes constructivos.

Capacitar a los docentes para enseñar a los estudiantes a evaluar críticamente la información, identificar desinformación y reconocer sesgos en diversas fuentes digitales, incluyendo contenidos generados por IA.
...
Comunidad Educativa Fortalecida

Conexión con otros docentes para compartir experiencias, co-crear materiales y resolver desafíos comunes.

Contáctanos para diseñar una propuesta
          a medida de tu comunidad educativa.

Crea un ambiente de aprendizaje donde estudiantes, docentes y familias colaboren para un uso más consciente y ético de la tecnología.
...
Desinformación, Verificación de Datos

Docentes Empoderados e Innovadores

Educación Mediática Digital

Educación Mediática Digital para Docentes · Precisar

Enseñar Participación Ética
...
Estudiantes Reflexivos y Resilientes

Facilitar la integración de la educación mediática digital en el currículo escolar, proporcionando guías y recursos que se adapten a diferentes asignaturas y niveles educativos.

Fomentar el Pensamiento Crítico

Formar a los docentes para que instruyan a sus alumnos sobre la participación activa, segura y respetuosa en redes y plataformas digitales, fomentando la ciudadanía digital.

Fortalece a tu equipo docente con herramientas prácticas, enfoque pedagógico actualizado y confianza para enfrentar los desafíos del entorno digital. Capacítalos para guiar a sus estudiantes en el uso crítico, seguro y creativo de la tecnología, y para liderar procesos de innovación educativa en sus comunidades escolares.

Fundamentos de la Educación Mediática Digital

Integración Curricular y Proyectos en Educación Mediática

Integrar la Educación Mediática

leer-noticias

Lleva la educación mediática
...
Producción de Contenidos Digitales y Ciudadanía
...
Promover la Producción Responsable
...
Soporte y seguimiento personalizado para asegurar el acompañamiento en sala de aula.

Talleres Prácticos Online

Un camino estructurado

y transforma la experiencia educativa
...
■ FUNCIONARIOS PÚBLICOS · PROGRAMA 06

8 sesiones diseñadas para el contexto de la administración pública.

Adaptamos a tu institución

Agendamos una presentación

Al entender algoritmos, cámaras de eco y aprender a identificar desinformación, deepfakes y propaganda, los funcionarios protegen la reputación institucional.
...
Contáctanos para recibir una propuesta formal que incluya la inversión y la logística de implementación para tus equipos.

Contenido y estructura del curso

Coordinamos una reunión para presentar el programa en detalle y resolver todas tus preguntas.

directo para la democracia.

Diseñamos el programa a medida de las necesidades específicas de tu organización.
...
Herramientas para una comunicación más efectiva y transparente a través de los medios y redes sociales, aumentando la confianza de los ciudadanos en la institución.
...
Los funcionarios estarán capacitados para buscar, filtrar y evaluar información relevante y confiable, mejorando la calidad de las decisiones internas y el desempeño diario.
...
Se promueve una mentalidad analítica entre los colaboradores, permitiéndoles abordar la información de manera reflexiva y consciente, fundamental para una gestión pública moderna.
...
■ HUB DIGITAL CONSCIENTE · PROGRAMA 02

Cultura digital que viaja a donde están las personas.

Diseñada para cualquier espacio.
...
Exploración interactiva del Hub Digital Consciente
...
¿Cómo navegar en un mundo con IA?

¿Por qué las noticias falsas son tan atractivas?
...
01 Solicita una propuesta detallada.

02 Coordinamos una presentación.

03 Co-creamos el programa a tu medida.

Adapta el programa a las necesidades específicas de tu institución.

Al dominar el pensamiento crítico, tus colaboradores se convierten en agentes de apoyo en sus comunidades y familias, contribuyendo a una sociedad mejor informada.

Al dotar a tus equipos de herramientas para identificar, analizar y verificar información, mejoras su capacidad para tomar decisiones acertadas y optimizar su tiempo.

Al finalizar serás capaz de:

Alfabetización Mediática y Digital en la Era de la IA

Aplicar una lista de chequeo de 3 pasos para evaluar cualquier noticia.

Beneficios para tu organización

Capacitar en la detección de desinformación disminuye el riesgo de que la organización actúe basándose en datos falsos, previniendo crisis y protegiendo la reputación.

Cómo las plataformas aprenden de tus gustos para crear un perfil sobre ti y el fenómeno de la burbuja de filtros.

Competente. Informado.

Consejos prácticos para moverte en este nuevo escenario y valorar las fuentes de información confiables.
...
Conversar con calma con amigos o familiares que comparten información falsa.

Día completo · 7 horas
...
Ejemplos cotidianos como una receta de cocina para explicar qué es un algoritmo y cómo lo usan Spotify, Netflix, Facebook e Instagram.

El chef secreto de tu internet: ¿Qué es un algoritmo?

El método de los 3 pasos: Pausa, Pregunta y Compara
...
Entender cómo las plataformas personalizan el contenido que te muestran.
...
Herramientas fáciles al alcance de tu mano

Herramientas para identificar, analizar y verificar la información que circula en el mundo digital.

Identificar las nuevas formas en que la IA se usa para crear contenido real y falso.

Impacto Social

La llegada de la Inteligencia Artificial

Los cursos promueven un ambiente basado en el análisis de datos, el pensamiento crítico y el diálogo constructivo, reduciendo la polarización y mejorando la colaboración.

Los titulares impactantes o que provocan enojo están diseñados para que los compartamos sin pensar. Entender esto es el primer paso para no caer en la trampa.
...
Pausa: No compartir de inmediato. Pregunta: ¿Quién dice esto? ¿Por qué? Compara: ¿Algún medio serio informa lo mismo?
...
Plan de acción personal para consumir información de manera más saludable y consejos para actuar cuando alguien comparte algo falso.

Qué es la IA, cómo puede generar imágenes, textos y voces que parecen reales, y para qué se usa de forma positiva y cuáles son sus riesgos.

Reconocer el efecto de la burbuja de filtros en tu día a día.

Reconocer las señales de alerta más comunes en una noticia falsa.

Taller práctico donde aprenderás a usar la búsqueda inversa de imágenes de Google en tu propio celular.
...
Un mundo hecho para ti: La personalización y la burbuja

Usar herramientas gratuitas para saber si una foto es real o si es antigua.

## Aprender Digital

Programa para adultos y mayores — autonomía y criterio digital con Precisar.

¿Representas a un municipio, junta de vecinos o centro comunitario? Llevamos el programa a tu espacio.
...
Cultura digital para toda la ciudad — programas municipales Precisar.

Cultura digital para toda la ciudad — programas municipales Precisar.

Modular, flexible y 100% adaptable a las prioridades de tu municipio.

## Formación en pensamiento crítico

Talleres concretos de verificación y algoritmos — Precisar.

¿Quién dice esto? ¿Por qué? ¿Algún otro medio serio lo confirma?

¿Y ahora qué hago?

0.5px solid rgba(219, 82, 39, 0.2)
...
Búsqueda inversa de imágenes: descubre si esa foto es de hace 10 años en otro país.

Cada organización tiene necesidades distintas. Conversamos, ajustamos y ejecutamos. Sin propuestas genéricas.

Cómo las plataformas construyen un perfil tuyo. La burbuja de filtros.

Conversar con calma con alguien que comparte desinformación

El chef secreto de tu internet

Explicar con un ejemplo simple qué es un algoritmo

Formación en pensamiento crítico

Herramientas en tu celular

Herramientas y hábitos para moverse sin pánico ni ingenuidad.
...
Los titulares que provocan enojo están diseñados para que compartas sin pensar.
...
Para quien quiere entender qué hay detrás del scroll.

Para quien recibe cadenas en WhatsApp y ya no sabe qué creer.

Pausa. Pregunta. Compara.

Plan de acción personal y guía para hablar con tu círculo cercano.

Por qué las noticias falsas funcionan

Qué es un algoritmo, explicado con ejemplos de Spotify, Netflix y redes sociales.

Que no te engañen.
Aprende a verificar.

Qué puede crear la IA hoy: imágenes, textos, voces que parecen reales.
...
Formación en educación mediática para la administración pública — Precisar.

Adaptamos el programa a las necesidades específicas de tu institución. Propuesta formal con inversión y logística incluidas.

Consideramos esta capacitación una inversión estratégica en la resiliencia de la administración pública.
...
La cultura digital entra por la puerta — instalación itinerante Precisar.

Hub Digital Consciente

La cultura digital entra por la puerta — instalación itinerante Precisar.

Trabajamos con municipios, universidades, organizaciones sociales y empresas.

Tu próximo evento puede provocar una conversación necesaria.
...
¿Por qué necesitamos evaluar críticamente los contenidos en línea?

/covers/30-preguntas-explora-vida-digital.png

/covers/portada-evaluar-contenidos.png

/covers/portada-guia-practica-ia.png

/covers/portada-ia-en-aula.png

/covers/portada-primeros-pasos-ami.png

/covers/portada-uso-consciente-ia.png

/covers/portada-verificar-imagenes.png

/recursos-30-preguntas.pdf

/recursos-evaluar-contenidos.pdf

/recursos-guia-practica-ia.pdf

/recursos-guia-primeros-pasos-ami.pdf

/recursos-ia-en-aula.pdf

/recursos-uso-consciente-ia.pdf

/recursos-verificar-imagenes-videos.pdf
...
Guía Práctica de Primeros Pasos en Educación Mediática e Informacional en Chile
...
Guía Práctica sobre Inteligencia Artificial (IA)

Guía Práctica: Cómo Verificar Imágenes y Videos
...
Inteligencia Artificial en el Aula: Qué, Cómo y Para Qué
...
Recursos descargables · Precisar
...
## Co-diseñamos con el contexto

./_components/SomosReveal

Acompañamiento institucional para que las capacidades queden instaladas.

Acompañamiento para adopción institucional

Apoyo a equipos y organizaciones para incorporar esta agenda desde sus propios roles, capacidades y objetivos.

Buscamos que las organizaciones puedan apropiarse de metodologías, recursos y herramientas, integrándolos en sus propias prácticas más allá de una intervención puntual.
...
Combinamos claridad, tecnología y sentido público
...
Desarrollamos herramientas abiertas, contenidos accesibles y experiencias aplicadas que permitan comprender mejor cómo circula la información y cómo usar la tecnología de forma más consciente y provechosa.

Diagnóstico y escucha

Diseñamos e implementamos experiencias en contextos reales, con públicos concretos y condiciones diversas, para aprender, ajustar y dejar modelos replicables.

Diseño e implementación de modelos de trabajo para municipios, escuelas, organizaciones y servicios públicos.
...
Guías, actividades, materiales explicativos, experiencias participativas y herramientas conversacionales adaptadas a diferentes públicos y etapas de vida.
...
Metodologías para territorios e instituciones

Metodologías probadas en contextos reales

Municipios y gobiernos locales

No aplicamos fórmulas únicas. Adaptamos metodologías, herramientas y recursos a las necesidades, lenguajes y capacidades de cada organización y de las comunidades con las que trabaja.

No trabajamos desde soluciones cerradas. Partimos del contexto, escuchamos cómo viven este problema las personas y diseñamos junto a cada aliado formas de abordarlo con sentido práctico, lenguaje claro y capacidad de implementación.
...
Porque combinamos cuatro capacidades que no suelen aparecer juntas:

Principio de trabajo

Probamos en terreno

Procesos para comprender cómo se informan distintos públicos, qué dificultades enfrentan y qué tipo de apoyo necesitan.

Producimos y organizamos evidencia útil para comprender cómo se informan las personas, qué barreras enfrentan y qué herramientas pueden ser más efectivas para acompañarlas.
...
Recursos y herramientas abiertas
...
Sistematización de aprendizajes y generación de insumos útiles para mejorar prácticas, programas y formas de comunicación.
...
Traducimos evidencia en acción

Transferimos capacidades

Una mejor conexión entre evidencia, comunicación y acción

## 30 preguntas para explorar tu vida digital · Una Pregunta al Día
...
prose-precisar max-w-none space-y-6
